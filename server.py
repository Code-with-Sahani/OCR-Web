...
# Below the image directory which we have to Scanned. 
image = cv2.imread("images\current-run.jpg") 
...
#Below another Method to extract the charactor according to the words. 
